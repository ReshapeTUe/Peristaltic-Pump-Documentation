...
# Publication
A paper presenting this pump and the associated cleaning procedure has been accepted for the International Conference on Soft Robotics (RoboSoft), 2023. This paper can be found in the main directory.

The work can be cited as follows:
- **Proper. B, Caasenbrood, B., & I. Kuling (2023). Easy Cleaning of 3D SLA/DLP Printed Soft Fluidic Actuators with Complex Internal Geometry. 6th IEEE International Conference on Soft Robotics, RoboSoft 2023. (Accepted).**
